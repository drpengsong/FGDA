...
class mySolver(object):
    ...
    def __init__(self, config):
        ...
        self.source_loader = get_office31_dataloader(case='amazon', mode='source', batch_size=self.BATCH_SIZE[0])
        print('source : {}_{}'.format(len(self.source_loader), len(self.source_loader.dataset)))
        self.target_loader = get_office31_dataloader(case='webcam', mode='targettrian', batch_size=self.BATCH_SIZE[1])
        print('target : {}_{}'.format(len(self.target_loader), len(self.target_loader.dataset)))

        self.source_loader_test = self.source_loader
        self.target_loader_test = get_office31_dataloader(case='webcam', mode='targettest',
    ...
    def train(self):
        ...
        root = '/data/result/FGDA/FGDA/semi-supervised/Office(ResNet)-{:.4f}'.format(max_acc) + '/'
